...
class MSVideo1_16bit implements IVideoCodec
{
	...
	public function new(width : Int, height : Int, num_buffers : Int) 
	{
...
class MSVideo1_8bit extends MSVideo1_16bit
{
	...
	public function new(width : Int, height : Int, num_buffers : Int, palette : ByteArray) 
	{
		//trace("MSVC.new 8bit");
		super(width, height, num_buffers);
		pal8 = palette;
